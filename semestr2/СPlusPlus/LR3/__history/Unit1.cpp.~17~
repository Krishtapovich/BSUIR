...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
	...
	else if(Form1->Edit3->Text == "" && Form1->Edit7->Text != "" && Form1->Edit6->Text == "")
	{
		...
		if(count == 0) ShowMessage("¬ таблице нет участника в указанной весовой категории!");
	...
	else if(Form1->Edit3->Text == "" && Form1->Edit7->Text == "" && Form1->Edit6->Text != "")
	{
		...
		{
			ShowMessage("¬ таблице нет команды, все учасники которой были бы выше введенного роста!");
			Edit6->Text = "";
		}
	}
	else ShowList();
