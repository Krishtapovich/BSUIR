...
string ifneg(string num, int size);//ЕСЛИ ОТРИЦАТЕЛЬНОЕ, ДЕЛАЕМ ПОЛОЖИТЕЛЬНОЕ

int* transfer_to_int(string num, int size);
char conversion(int c);

bool coincide(int* num1, int* num2, int size); // ПРОВЕРЯЕМ СОВПАДАЮТ ЛИ СИМВОЛЫ = НУЖЕН ЛИ ДОПОЛНИТЕЛЬНЫЙ РАЗРЯД
int compare(int* num1, int* num2, int size1, int size2); //УЗНАЕМ КАКОЕ ЧИСЛО БОЛЬШЕ ПО МОДУЛЮ

void sum(int* num1, int* num2, int size1, int size2);
void sum_if_coincide(int* num1, int* num2, int size1, int size2);//СЛОЖЕНИЕ, ЕСЛИ СИМВОЛЫ НЕ СОВПАДАЮТ
void sum_ifnot_coincide(int* num1, int* num2, int size1, int size2);//СЛОЖЕНИЕ, ЕСЛИ СИМВОЛЫ СОВПАДАЮТ

void sub(int* num1, int* num2, int size1, int size2);
void sub_if_s1nots2(int* num1, int* num2, int size1, int size2);	//ВЫЧИТАНИЕ, ЕСЛИ ДЛИНЫ НЕ СОВПАДАЮТ
